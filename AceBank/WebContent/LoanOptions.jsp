...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/AceBank/css/navbar-home.css">
...
<body>
    <header>
        ...
        <label for="nav-toggle" class="nav-toggle-label">
            <img src="/AceBank/images/menu-24px.svg">
        </label>
        <nav>
            <ul>
    ...
    <main>
        <section class="title">
            <h1>Choose a loan</h1>
            <p>You'll receive a mail at "<% out.print(msg); %>" with the details once you select a loan.</p>
        </section>
            ...
            <div class="cards-container">
                <div class="card card-one">
                    <div class="img-container">
                        <img src="/Ace/images/home.svg" alt="home loan icon">
                    </div>
